...
a. Knative
b. gVisor
c. New updates from Google Cloud
...
6. <a target="_blank"  href="https://programmingisterrible.com/post/173883533613/code-to-debug">Write code that’s easy to delete, and easy to debug too.</a>
